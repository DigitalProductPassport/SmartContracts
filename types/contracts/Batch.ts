...
export declare namespace Batch {
  ...
  export type BatchDetailsStructOutput = [
    ...
    transportDetails: string
  ] & { amount: bigint; assemblingTime: bigint; transportDetails: string };
}
...
export interface BatchInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "setBatchDetails",
...
export interface Batch extends BaseContract {
  connect(runner?: ContractRunner | null): Batch;
  ...
  getBatchDetails: TypedContractMethod<
    ...
    [Batch.BatchDetailsStructOutput],
    "view"
  >;
  ...
  setBatchDetails: TypedContractMethod<
    [
      batchId: BigNumberish,
      amount: BigNumberish,
      assemblingTime: BigNumberish,
  ...
  >;
  getFunction(
    nameOrSignature: "setBatchDetails"
  ): TypedContractMethod<
    [
      batchId: BigNumberish,
      amount: BigNumberish,
